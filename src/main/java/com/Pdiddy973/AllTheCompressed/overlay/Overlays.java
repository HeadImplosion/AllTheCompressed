...
//    BLAZE(Mods.BOTANIA, "blaze_block"),
    ...
    ACACIA_WOOD(Mods.MINECRAFT, "acacia_wood"),
    ...
    BIRCH_WOOD(Mods.MINECRAFT, "birch_wood"),
    ...
    CHERRY_WOOD(Mods.MINECRAFT, "cherry_wood"),
    ...
    CRIMSON_HYPHAE(Mods.MINECRAFT, "crimson_hyphae"),
    ...
    DARK_OAK_WOOD(Mods.MINECRAFT, "dark_oak_wood"),
    ...
    OAK_WOOD(Mods.MINECRAFT, "oak_wood"),
